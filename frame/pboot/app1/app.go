...
//func initApp() {
//	app = gs.NewApp()
//	vApp := reflect.ValueOf(app).Elem()
//	fmt.Printf("============%v\n", vApp.FieldByName("c").Elem())
//	//container = vApp.FieldByName("c").Elem().Interface().(gs.Container)
...
//}
//
//func InternalObject(i any) *pboot.Bean {
//	return setupLifeCycleModule(container.Object(i), pboot.OrderInternal)
//}
//
//func InternalProvide(ctor any, args ...arg.Arg) *pboot.Bean {
//	return setupLifeCycleModule(container.Provide(ctor, args...), pboot.OrderInternal)
//}
//
//func ConfigObject(i any) *pboot.Bean {
//	return setupLifeCycleModule(container.Object(i), pboot.OrderConfig)
//}
//
//func ConfigProvide(ctor any, args ...arg.Arg) *pboot.Bean {
//	return setupLifeCycleModule(container.Provide(ctor, args...), pboot.OrderConfig)
//}
//
//func DBObject(i any) *pboot.Bean {
//	return setupLifeCycleModule(container.Object(i), pboot.OrderDB)
//}
//
//func DBProvide(ctor any, args ...arg.Arg) *pboot.Bean {
//	return setupLifeCycleModule(container.Provide(ctor, args...), pboot.OrderDB)
//}
//
//func ToolsObject(i any) *pboot.Bean {
//	return setupLifeCycleModule(container.Object(i), pboot.OrderTools)
//}
//
//func ToolsProvide(ctor any, args ...arg.Arg) *pboot.Bean {
//	return setupLifeCycleModule(container.Provide(ctor, args...), pboot.OrderTools)
//}
//
//// Object 参考 Container.Object 的解释。
//func Object(i any) *pboot.Bean {
//	return setupLifeCycleModule(container.Object(i), pboot.OrderCustom)
//}
//
//// Provide 参考 Container.Provide 的解释。
//func Provide(ctor any, args ...arg.Arg) *pboot.Bean {
//	return setupLifeCycleModule(container.Provide(ctor, args...), pboot.OrderCustom)
//}
//
//func setupLifeCycleModule(bean *gs.BeanDefinition, baseOrder float32) *pboot.Bean {
//	lifeCycle := bean.Interface().(pboot.LifeCycle)
//	if lifeCycle != nil {
...
//		} else {
//			// 包装后再加入
//			wrapper := &pboot.lifeCycleWrapper{lc: lifeCycle}
//			container.Object(wrapper).Export((*gs.AppEvent)(nil))
//		}
//	}
//	return pboot.newBean(bean, baseOrder).Order(1)
//}
//
